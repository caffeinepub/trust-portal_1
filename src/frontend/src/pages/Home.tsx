...
import { ArrowRight, Award, BookOpen, Heart, Leaf, Users } from "lucide-react";
        ...
        <div className="container relative mx-auto px-4 py-24 md:py-32">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mb-8 text-lg text-muted-foreground md:text-xl">
              Manavdeep Seva Trust is dedicated to creating lasting positive
              change through community-driven initiatives, sustainable
              ...
              <div className="flex flex-col gap-6 md:flex-row md:gap-8">
                ...
                <div className="flex-1">
                  ...
                  <blockquote className="border-l-4 border-trust/40 pl-4 italic text-muted-foreground">
                    "मानव सेवा परमो धर्मः — Service to humanity is the highest
                    duty."
                  </blockquote>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mb-8 text-lg leading-relaxed text-muted-foreground">
              To empower communities through education, healthcare, women
              empowerment, elder care, and environmental conservation — building
              a society rooted in compassion, dignity, and sustainable progress.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mb-8 text-muted-foreground">
              Your support helps us continue our mission of serving the
              underprivileged and creating lasting change.
            </p>
            <div className="flex flex-col gap-4 sm:flex-row sm:justify-center">
              <Link
                to="/donations"
